...
% eerst moet je voor het make commando nog ./autogen.sh en ./configure uitvoeren. Nu blijkbaar niet meer.
...
\subsection{PiCanS88}
The next step is to install \textit{PiCanS88} to establish the CAN and connection. This tool is not used for the S88 communication, contrary to what the name suggests. To install PiCanS88:
...
\begin{verbatim}
	...
	-b 192.168.0.255 (broadcast address of your local home network)
	-d 192.168.0.58 (IP address of the Computer where your Rocrail server is running)
...
The CAN bus is now fully operational. 

\begin{comment}
SRCPD is needed to provide the interface between the can peripheral and rocrail. To install srcpd (version 2.1.6):
